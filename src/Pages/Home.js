                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Priyanshu Aggarwal</b>
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                      With a strong passion for both front-end and back-end development, I bring a diverse and comprehensive skill set to every project I undertake. My keen eye for design ensures visually appealing and user-friendly interfaces, while my analytical mind allows me to solve complex problems efficiently. I excel in creating seamless, dynamic web applications that not only meet user needs but also stand out in terms of performance and functionality. Currently, I'm expanding my expertise by learning React and Java Full Stack development, driven by my curiosity and dedication to delivering exceptional results in every project.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      <div className="main-title left-title text-left wow fadeIn">
                        <h3>Hi! I'm Priyanshu</h3>
                        <div className="underline1 no-margin"></div>
                        <div className="underline2 no-margin"></div>
                      </div>
                      <p className="wow fadeIn">
                        I am a software developer based in Delhi, India,
                        currently in my Final Year of B.tech in CSE, from Inderprastha Engineering College.
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".2s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          I completed my secondary education at Bal MAndir Sr. Sec. School
                          School in Preet Vihar, Delhi, India.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".4s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          I have been learning about Java Full Stack as well as AWS
                          Development training. Aim to improve everyday.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-4 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".6s">
                        ...
                        <a
                          href="public\assets\latest_resume.pdf"
                          target="_blank"
                          style={{
                            color: "black",
                            textDecoration: "none",
                        ...
                        >
                          https://priyanshu-aggarwal-8.github.io
                        </a>
                      </div>
                    </div>
                  </div>
